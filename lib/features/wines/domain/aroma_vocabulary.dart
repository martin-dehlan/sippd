...
/// Canonical aroma tags, loosely grouped (red fruit → black fruit → citrus
/// → tropical → floral → herbal → spice → oak/roast → earth → other). Order
/// is the display order in the chip list.
const kAromaTags = <String>[
  // Red fruit
  'cherry', 'raspberry', 'strawberry', 'redcurrant', 'cranberry',
  // Black fruit
  'plum', 'blackcurrant', 'blackberry', 'blueberry',
  // Orchard / stone fruit
  'apple', 'pear', 'quince', 'peach', 'apricot', 'nectarine',
  // Citrus
  'lemon', 'lime', 'grapefruit', 'orange',
  // Tropical
  'pineapple', 'mango', 'passion fruit', 'lychee', 'melon',
  // Floral
  'rose', 'violet', 'honeysuckle', 'jasmine', 'elderflower', 'blossom',
  // Herbal / vegetal
  'bell pepper', 'mint', 'eucalyptus', 'grass', 'thyme', 'fennel',
  // Spice
  'black pepper', 'white pepper', 'clove', 'cinnamon', 'nutmeg', 'liquorice',
  // Oak / roast
  'vanilla', 'toast', 'smoke', 'cedar', 'coffee', 'chocolate', 'caramel',
  // Earth / savoury
  'leather', 'tobacco', 'mushroom', 'forest floor', 'wet stone', 'mineral',
  // Dairy / nutty / other
  'honey', 'butter', 'cream', 'almond', 'hazelnut', 'bread',
];

const _kAromaVocab = <String>{...kAromaTags};
