...
abstract class $WineModelCopyWith<$Res> {
  ...
  $Res call({
    ...
    double? abv,
    String? aroma,
    @JsonKey(name: 'food_pairings') String? foodPairings,
...
class _$WineModelImpl implements _WineModel {
  const _$WineModelImpl({
    ...
    this.abv,
    this.aroma,
    @JsonKey(name: 'food_pairings') this.foodPairings,
...
abstract class _WineModel implements WineModel {
  const factory _WineModel({
    ...
    final double? abv,
    final String? aroma,
    @JsonKey(name: 'food_pairings') final String? foodPairings,
