...
_$WineModelImpl _$$WineModelImplFromJson(Map<String, dynamic> json) =>
    _$WineModelImpl(
      ...
      canonicalGrapeId: json['canonical_grape_id'] as String?,
      grapeFreetext: json['grape_freetext'] as String?,
      canonicalWineId: json['canonical_wine_id'] as String?,
      winery: json['winery'] as String?,
      servingTempC: (json['serving_temp_c'] as num?)?.toInt(),
      decantMinutes: (json['decant_minutes'] as num?)?.toInt(),
      abv: (json['abv'] as num?)?.toDouble(),
      aroma: json['aroma'] as String?,
      foodPairings: json['food_pairings'] as String?,
...
Map<String, dynamic> _$$WineModelImplToJson(_$WineModelImpl instance) =>
    <String, dynamic>{
      ...
      'grape_freetext': instance.grapeFreetext,
      'canonical_wine_id': instance.canonicalWineId,
      'winery': instance.winery,
      'serving_temp_c': instance.servingTempC,
      'decant_minutes': instance.decantMinutes,
      'abv': instance.abv,
      'aroma': instance.aroma,
      'food_pairings': instance.foodPairings,
